export const HOSPITAL_CONFIG = {
  name: "আলোক হেলথ কেয়ার",
  nameEn: "Alok Health Care",
  ...
  address: "আলোক হেলথকেয়ার এন্ড ডায়গনস্টিক সলিউশন। জেলা হাসপাতালের পশ্চিম পাশে,এল-জি শো-রুমের দ্বিতীয় তলা, পিরোজপুর।",
...
export const NAV_LINKS = {
  ...
  services: "পরীক্ষা নিরীক্ষা ও বিভাগসমূহ",
