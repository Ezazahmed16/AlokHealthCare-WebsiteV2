        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-16 items-start">
          ...
          <div className="flex flex-col items-center md:items-start space-y-6">
            ...
            <p className="text-[#F9FAFB] leading-relaxed text-center md:text-start max-w-[320px]">
              আলোক হেলথকেয়ার এন্ড ডায়াগনষ্টিক সলিউশন পিরোজপুরে প্রথম আধুনিক চিকিৎসা প্রতিষ্ঠান যা সর্বোচ্চ মানের স্বাস্থ্যসেবা নিশ্চিত করতে প্রতিজ্ঞাবদ্ধ। আপনার সুস্থতার জন্য আমরা সবসময় আপনার পাশে আছি।
            </p>
